...
std::vector<float> projection_single_point_on_creen(glm::vec3 point, glm::mat4 model, glm::mat4 camera, glm::mat4 projection)
{
	...
	std::cout <<"projected_point in clipped space: "<< projected_point[0]/projected_point[3]<<" " << projected_point[1]/projected_point[3]<<" "<<projected_point[2]/projected_point[3]<<" "<<projected_point[3]<<std::endl;
	...
	//std::cout <<" center: "<<camera_coordinate[2] / camera_coordinate[3] << " " << projected_point[3] << std::endl;
	return coordinate;
}
